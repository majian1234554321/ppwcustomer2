...
class PayPresent(var context: Context, var payViiew: PayView) : BasePresent() {
    ...
    fun paymentByWx(id: String?, money: String?) {
        ...
        map["id"] = id
        map["money"] = money
        toSubscribe2(ApiServices.getInstance().create(PayService::class.java).paymentByWx(map),
    ...
    fun paymentByAli(id: String, money: String) {
        ...
        map["id"] = id
        map["money"] = money
        toSubscribe2(ApiServices.getInstance().create(PayService::class.java).paymentByAli(map),
            object : ProcessObserver2(context) {
                override fun processValue(response: String?) {
