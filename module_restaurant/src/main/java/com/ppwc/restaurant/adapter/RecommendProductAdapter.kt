...
class RecommendProductAdapter(data: List<String>) : BaseQuickAdapter<String, BaseViewHolder>(R.layout.recommendproductadapter, data) {
        override fun convert(helper: BaseViewHolder?, item: String?) {
            ...
            helper?.setText(R.id.tv_price,item)
