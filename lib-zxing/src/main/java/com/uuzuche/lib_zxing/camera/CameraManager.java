...
//      }
    ...
    public Rect getFramingRect() {
        ...
        int scal = (screenResolution.x - FRAME_WIDTH) / 3 -(screenResolution.x - FRAME_WIDTH) / 2;
        ...
        int topOffset = 0;
            ...
            framingRect = new Rect(leftOffset+scal, topOffset+scal, leftOffset + FRAME_WIDTH-scal, topOffset + FRAME_HEIGHT-scal);
        // }
        return framingRect;
    }
